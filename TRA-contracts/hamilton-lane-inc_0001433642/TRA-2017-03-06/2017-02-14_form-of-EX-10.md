...
:   means the lesser of (i) 7.5% and (ii) LIBOR plus 400 basis points.
...
LIBOR
:   means, during any month, a rate per annum equal to the USD LIBOR rate for a period of one month as published by the Wall Street Journal two (2) Business Days prior to the commencement of such month, for dollar deposits (for delivery on the first day of such month).
