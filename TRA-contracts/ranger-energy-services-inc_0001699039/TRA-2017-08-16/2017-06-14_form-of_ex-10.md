...
RANGER ENERGY SERVICES, INC. · CERTAIN OTHER PERSONS NAMED HEREIN, · \[ \], AS AGENT · DATED AS OF \[ \], 2017.
...
:   means, as of an Early Termination Date, the assumptions that:
    ...
    (v)                                 if, at the Early Termination Date, there are Units that have not been transferred in an Exchange, then all Units shall be deemed to be transferred pursuant to the Redemption Right effective on the Early Termination.
