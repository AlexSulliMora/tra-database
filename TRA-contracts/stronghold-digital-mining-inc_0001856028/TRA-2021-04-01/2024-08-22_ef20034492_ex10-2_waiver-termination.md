---
title: "TRA WAIVER AND TERMINATION AGREEMENT"
format:
  html:
    toc: true
    toc-depth: 3
...
Email: xxxxxx@xxxxxx.com with a copy (which shall not constitute notice or service of process) to:
...
\[Signature pages follow.\] IN WITNESS WHEREOF, the Parties have executed this Waiver Agreement as of the date set forth above.
...
Name:   Matthew C. Usdin

Title:     SVP & General Counsel

\[Signature Page to TRA Waiver and Termination Agreement\] \[Signature Page to TRA Waiver and Termination Agreement\] Address for notices to Holder pursuant to Section 14:
...
\[Signature Page to TRA Waiver and Termination Agreement\] Address for notices to Holder pursuant to Section 14:
...
xxxxxx Attention: William Spence \[Signature Page to TRA Waiver and Termination Agreement\]
