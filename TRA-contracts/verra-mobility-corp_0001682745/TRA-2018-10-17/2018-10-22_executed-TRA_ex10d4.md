...
[]{#_Toc516426489}1.1Definitions.  As used in this Agreement, the terms set forth in this ARTICLE I have the following meanings.
...
Affiliate
:   means, with respect to any specified Person, (a) any other Person that directly or indirectly, through one or more intermediaries, Controls, is Controlled by, or is under common Control with, such specified Person, (b) a Member of the Immediate Family of such specified Person, and (c) any investment fund advised or managed by, or under common control or management with, such specified Person.
...
Determination
:   has the meaning ascribed to such term in Section 1313(a) of the Code or similar provisions of state and local Tax Law, as applicable, or any other event (including the execution of IRS Form 870-AD) that finally and conclusively establishes the amount of any liability for Tax.
...
:   with respect to a Stockholder, means the percentage set forth opposite such Stockholder's name on Schedule 1.
...
TRA Payment
:   means a Tax Benefit Payment, an Early Termination Payment and any Divestiture Acceleration Payment.
...
:   means any securities of the Corporate Taxpayer which are entitled to vote generally in matters submitted for a vote of the Corporate Taxpayer's stockholders or generally in the election of the Board.
    ...
    []{#_Toc516426490}1.2Terms Generally.  In this Agreement, unless otherwise specified or where the context otherwise requires:
    ...
    []{#_AEIOULastRenderedPageBreakAEIOU12}(k)references to "$" or "dollars" means the lawful currency of the United States of America;
...
[]{#_Toc516426492}[]{#_Ref452900335}2.1Tax Benefit Schedule.
...
\[Signature page follows\] []{#_AEIOULastRenderedPageBreakAEIOU26}IN WITNESS WHEREOF, the undersigned have duly executed this Agreement as of the date first written above.
...
\[Signature Page to Tax Receivable Agreement\] []{#_AEIOULastRenderedPageBreakAEIOU27}EXHIBIT A Form of Joinder to the Tax Receivable Agreement This JOINDER (this "Joinder") to the Tax Receivable Agreement (as defined below), dated as of October 17, 2018, by and among Gores Holdings II, Inc., a Delaware corporation (the "Corporate Taxpayer"), and \[●\] (the "Permitted Transferee").

WHEREAS, on \[●\], the Permitted Transferee acquired (the "Acquisition") from \[●\] (the "Transferor") the right to receive any and all payments that may become due and payable to the Transferor under the Tax Receivable Agreement (as defined below); and WHEREAS, the Transferor, in connection with the Acquisition, has required the Permitted Transferee to execute and deliver this Joinder pursuant to Section 7.5 of the Tax Receivable Agreement, dated as of October 17, 2018, by and between the Corporate Taxpayer, the Stockholders (as defined therein) (the "Tax Receivable Agreement").
...
\[Signature page follows\] []{#_AEIOULastRenderedPageBreakAEIOU28}IN WITNESS WHEREOF, the undersigned have duly executed this Joinder as of the date first above written.
...
\[Signature Page to Joinder to Tax Receivable Agreement\] []{#_AEIOULastRenderedPageBreakAEIOU29}SCHEDULE 1 Stockholders

PE Greenlight Holdings, LLC 100%
