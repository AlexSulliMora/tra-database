...
FLOWCO HOLDINGS INC. · THE PERSONS NAMED HEREIN · Dated as of January 17, 2025.
...
Blocker Merger Subs
:   means each of: Flowco Merger Sub I, Inc.; Flowco Merger Sub II, Inc.; and Flowco Merger Sub III, Inc..
...
** 3.3.** **Pro Rata Payments**. Notwithstanding anything in [Section 3.1](#section-3-1) to the contrary, to the extent that the aggregate Realized Tax Benefit of PubCo with respect to the Tax Attributes is limited in a particular Taxable Year because PubCo does not have sufficient taxable income, the Net Tax Benefit for that Taxable Year shall be allocated among all parties then-eligible to receive Tax Benefit Payments under this Agreement in proportion to the amounts of Net Tax Benefit for that Taxable Year, respectively, that would have been Attributable to each TRA Party if PubCo had sufficient taxable income so that there were no such limitation. For the avoidance of doubt, the determination of whether Tax Benefit Payments are held back pursuant to [Section 3.6](#section-3-6), shall not be relevant in the determination of whether a Net Tax Benefit is eligible to be allocated to the relevant TRA Party for purposes of this [Section 3.3](#section-3-3).

### Section 3.4: SECTION {#section-3-4}

** 3.4.** **Payment Ordering**. If for any reason PubCo does not fully satisfy its payment obligations to make all Tax Benefit Payments due under this Agreement in respect of a particular Taxable Year, then PubCo and the TRA Parties agree that (i) Tax Benefit Payments for such Taxable Year shall be allocated to all parties eligible to receive Tax Benefit Payments under this Agreement in such Taxable Year in proportion to the amounts of Tax Benefit Payments, respectively, that would have been made to each TRA Party if PubCo had sufficient cash available to make such Tax Benefit Payments and (ii) no Tax Benefit Payments shall be made in respect of any Taxable Year until all Tax Benefit Payments to all TRA Parties in respect of all prior Taxable Years have been made in full; provided, however, that any payments that were previously held by PubCo on behalf of a TRA Party and have now become due and payable pursuant to [Section 3.6](#section-3-6) shall be made prior to any other Tax Benefit Payments.

### Section 3.5: SECTION {#section-3-5}

** 3.5.** **Limitation**. For the avoidance of doubt, notwithstanding anything to the contrary herein, in no event shall the aggregate of the Net Tax Benefit that is Attributable to each of the TRA Parties for a Taxable Year, as determined pursuant to the first sentence of [Section 3.1](#section-3-1)(b), exceed the total Net Tax Benefit for such Taxable Year, as determined pursuant to the third sentence of [Section 3.1](#section-3-1)(b). To the extent the aggregate Net Tax Benefit for a Taxable Year is limited as a result of the foregoing sentence (such excess, the "**Excess Amount**"), then the amount of the Net Tax Benefit that is Attributable to the TRA Parties for that Taxable Year shall be reduced by such Excess Amount in such a manner that best effectuates the applicable principles set forth in [Section 2.3](#section-2-3)(b) and in the good faith discretion of PubCo; provided, however, (i) to the extent that the Excess Amount for a Taxable Year would be Attributable to the Blocker Shareholders solely as a result of determining Blocker Transferred Basis based on the use of curative allocations under Section 704(c) of the Code applied only to gain from the sale of assets of the OpCo, and (ii) except to the extent such Net Tax Benefit arises as a result of the use of such method upon the actual sale or other disposition of a Reference Asset, then the Net Tax Benefit Attributable to the Blocker Shareholders shall be reduced, with such reduction allocated as among the Blocker Shareholders pro rata based on the Blocker Transferred Basis that is Attributable to such Blocker Shareholders.

### Section 3.6: SECTION {#section-3-6}

** 3.6.** **IPO Basis**. Notwithstanding anything to the contrary herein, any and all Tax Benefit Payments that would otherwise be made pursuant to this Agreement with respect to any IPO Basis shall be held by PubCo for the benefit of the applicable TRA Party (without any interest thereon) until such time as such TRA Party has exchanged Units in one or more Exchanges equal to 5% of the Units held by such TRA Party (as determined prior to the Reorganization, and after giving effect to the IPO Liquidating Distributions), (such Units, with respect to each TRA Party, such TRA Party's "**Threshold Exchange Units**"). Promptly following the time any such TRA Party has exchanged, in the aggregate, a number of Units equal to or exceeding the Threshold Exchange Units, such withheld amount shall be paid by PubCo to the applicable TRA Party. Notwithstanding anything herein to the contrary, all Blocker Shareholders (with respect to the Acquired Units) shall be deemed to have exchanged any Threshold Exchange Units held by such Blocker Shareholders in the Reorganization, and, therefore, no amounts shall be held back pursuant to this [Section 3.6](#section-3-6).
...
Attention: Joel Lambert, General Counsel
...
Title: Chief Executive Officer
  ...
  **Genesis Park II, LP**                                       **Sean Ratzlaff**
  **John Gatlin**                                               **Matthew Young**
  **Chad Roberts**                                              **Charles Stevens**
  **Christopher D. Courtney**                                   **Clint Bell**
  **Will Nelle**                                                **Tommy Hunt**
  **Steven Schwin**                                             **David Dahlgren**
  **Ryan Reynolds**                                             **Grant Marcoux**
  **Michael Carnes**                                            **Joseph Irvin**
  **Matthew Langford**                                          **Darrel Boyd**
  **Joni Rice**                                                 **Garrett Winford**
  **Kelby Danes**                                               **John Mark Lee**
  **William G. Elmer and Cynthia P. Elmer**                     **Susan Horton**
  **Eric McClure**                                              **JD Spencer**
  **Max Lift, LLC**                                             **Brandon Dobbs**
  **Board of Regents of the University of Texas System**        **Dean Lehner**
  **Forge4 Trust**                                              **Brooks Mims Talton, III**
  **Charles Jones**                                             **James A. Merrill**
  **Michael Spencer Harlow Irrevocable Trust**                  **Drake Andarakes**
  **Lauren Elizabeth Harlow Irrevocable Trust**                 **Aaron Baker**
  **Private Advisors Real Assets Fund II, LP**                  **Jason Fortner**
  **Thomas Reed Collins**                                       **Charles Crenshaw**
  **Buddy Davis**                                               **Kevin Pollard**
  **Daniel Isbell**                                             **Denis Mark Baker**
  **Terrance Tremel**                                           **Jonathan David Waggoner**
  **Can't Touch This, LLC**                                     **Larry W. Brickman**
  **Hershey's Pot of Gold, LLC**                                **Garrett Boyd**
  **Shawn Radcliff**                                            
  -------------------------------------------------------- ---- -----------------------------
...
This JOINDER (this "Joinder") to the Tax Receivable Agreement (as defined below), is by and among Flowco Holdings Inc. a Delaware corporation (including any successor corporation, "PubCo"), \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ ("Transferor") and \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ ("Permitted Transferee").
...
|                                   |             |             |             |                                    |
+-----------------------------------+-------------+-------------+-------------+------------------------------------+
| **White Deer Blockers**           |             | **  **      |             | **White Deer Blocker Shareholder\  |
|                                   |             |             |             | Percentages**                      |
+-----------------------------------+-------------+-------------+-------------+------------------------------------+
| WDE Flogistix Upper TE, LLC       |             |             |             | WD Thunder CV Parallel LP: 22.96%% |
|                                   |             |             |             |                                    |
|                                   |             |             |             | WD Thunder CV IND LP: 6.75%        |
|                                   |             |             |             |                                    |
|                                   |             |             |             | WD Thunder CV LP: 70.29%           |
+-----------------------------------+-------------+-------------+-------------+------------------------------------+
|                                   |             |             |             |                                    |
+-----------------------------------+-------------+-------------+-------------+------------------------------------+
| WDE Flogistix Upper FI, LLC       |             |             |             | WD Thunder CV Parallel LP: 22.96%  |
|                                   |             |             |             |                                    |
|                                   |             |             |             | WD Thunder CV IND LP: 6.75%        |
|                                   |             |             |             |                                    |
|                                   |             |             |             | WD Thunder CV LP: 70.29%           |
...
|                                   |             |             |             |                                    |
+-----------------------------------+-------------+-------------+-------------+------------------------------------+
| WD Thunder CV Parallel Blocker LP |             |             |             | WD Thunder CV Parallel LP: 100%    |
|                                   |             |             |             |                                    |
|                                   |             |             |             | WD Thunder CV IND LP: 0%           |
|                                   |             |             |             |                                    |
|                                   |             |             |             | WD Thunder CV LP: 0%               |
+-----------------------------------+-------------+-------------+-------------+------------------------------------+
