---
title: "AMENDMENT NO. 1 TO THE TAX RECEIVABLE AGREEMENT (EXCHANGES)"
format:
  html:
    toc: true
    toc-depth: 3
...
\[Signature Page to Amendment No. 1 to Tax Receivable Agreement (Exchanges)\] IN WITNESS WHEREOF, the undersigned have executed this Amendment as of the date first written above.
...
\[Signature Page to Amendment No. 1 to Tax Receivable Agreement (Exchanges)\]
