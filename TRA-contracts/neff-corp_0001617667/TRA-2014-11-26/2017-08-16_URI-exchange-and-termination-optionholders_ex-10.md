...
3750 N.W. 87111 Avenue, Suite 400 Miami, Florida  33178 Attn:  Chief Financial Officer Facsimile:  (305) 513-4156 E-mail:  mirion@neffcorp.com (g)                                  Entire Agreement. This Agreement (including the documents and the instruments referred to herein) constitutes the entire agreement among the Parties with respect to the subject matter hereof and supersedes all prior agreements and undertakings.
...
\[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] \[Signature Page for Exchange and Termination Agreement\] **Exhibit A** (1)         Does not give effect to the exercise price and tax withholding contemplated by Section 1(d).
...
+------------------+-----------+------------------+-----------+------------------+-----------+
| **Optionholder** | ** **     | **Number of LLC\ | ** **     | **Number of LLC\ | ** **     |
|                  |           | Options**        |           | Units(1)**       |           |
+------------------+-----------+------------------+-----------+------------------+-----------+
| Graham Hood      |           | 354,288          |           | 354,288          |           |
+------------------+-----------+------------------+-----------+------------------+-----------+
| James Continenza |           | 20,433           |           | 20,433           |           |
+------------------+-----------+------------------+-----------+------------------+-----------+
| Mark Irion       |           | 211,272          |           | 211,272          |           |
+------------------+-----------+------------------+-----------+------------------+-----------+
| Robert Singer    |           | 14,303           |           | 14,303           |           |
+------------------+-----------+------------------+-----------+------------------+-----------+
| Steve Michaels   |           | 60,131           |           | 60,131           |           |
+------------------+-----------+------------------+-----------+------------------+-----------+
| Westley Parks    |           | 97,510           |           | 97,510           |           |
+------------------+-----------+------------------+-----------+------------------+-----------+
